...
namespace Chronoscope
{
    ...
    {
        public ChronoscopeContext(ISystemClock clock, ITrackingSinks sink, ITrackingEventFactory eventFactory, ITrackerStopwatchFactory stopwatchFactory, ITrackingScopeFactory scopeFactory, ITrackerFactory trackerFactory)
        {
